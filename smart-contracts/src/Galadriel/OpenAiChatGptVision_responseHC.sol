// We faced too many issues with trying to get the Galadriel Oracle contract to work.
// This contract is exactly the same as the OpenAiChatGptVision contract, but has a hardcoded random return value.
...
contract OpenAiChatGptVision {
        ...
        returns (uint256)
    {
        ...
        string memory randomValue = (block.timestamp % 10).toString();

        emit ChatCreated(msg.sender, currentId);
        emit ResponseReceived(owner, chatId, true, randomValue);
