...
export default function SaleUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setAiModelId(cleanValues.aiModelId);
    setPriceListed(cleanValues.priceListed);
    setPricePaid(cleanValues.pricePaid);
    setIsAuction(cleanValues.isAuction);
    setApp(cleanValues.app);
    setSellerssWallet(cleanValues.sellerssWallet);
    setBuyersWallet(cleanValues.buyersWallet);
    setTransactionLedgerId(cleanValues.transactionLedgerId);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        let modelFields = {
          ...
          priceListed: priceListed ?? null,
          pricePaid: pricePaid ?? null,
          isAuction: isAuction ?? null,
          app: app ?? null,
          sellerssWallet: sellerssWallet ?? null,
          buyersWallet: buyersWallet ?? null,
          transactionLedgerId: transactionLedgerId ?? null,
          status: status ?? null,
