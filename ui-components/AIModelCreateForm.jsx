...
import { createAIModel } from "./graphql/mutations";
const client = generateClient();
export default function AIModelCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setSerialisedConfig(initialValues.serialisedConfig);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createAIModel.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "AIModelCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
